...
const Orders = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      toast.error('Failed to load orders and suppliers');
      console.error(error);
    } finally {
      setIsLoading(false);
    }
  ...
  const getStatusColor = (status) => {
    ...
    switch (status.toLowerCase()) {
      ...
      case 'counter_offer': return 'outline';
      default: return 'default';
    }
  };

  // Helper to safely format Firebase timestamp
        ...
        <TabsContent value="orders" className="space-y-4">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                <CardTitle>Purchase Orders</CardTitle>
                <CardDescription>Track AI-generated and manual purchase orders</CardDescription>
              </div>
            </CardHeader>
            <CardContent>
              {isLoading ? (
                    ...
                    <CardContent className="space-y-4">
                      <div className="space-y-2 text-sm">
                        <div className="flex items-center gap-2 text-muted-foreground">
                          ...
                          Location: {supplier.location || 'Not provided'}
                        </div>
                      </div>
                      <div className="flex items-center justify-between pt-2">
        ...
        <TabsContent value="deliveries" className="space-y-4">
          <Card>
            <CardContent className="flex flex-col items-center justify-center py-16 space-y-4">
              <Construction className="h-12 w-12 text-muted-foreground opacity-50" />
              <div className="text-center">
                <CardTitle className="text-xl mb-2">Delivery Tracking</CardTitle>
                <CardDescription>
                  This feature is currently under development. You will be able to track incoming shipments here soon.
                </CardDescription>
              </div>
            </CardContent>
          </Card>
